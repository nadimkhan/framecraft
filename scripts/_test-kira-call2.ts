...
async function main() {
  ...
  console.log('system length:', sys.system.length, '~', Math.round(sys.system.length/4), 'tokens')
  console.log('user length:', sys.user.length, '~', Math.round(sys.user.length/4), 'tokens')
